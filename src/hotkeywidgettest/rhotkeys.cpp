...
RHotKeys::RHotKeys(QWidget *parent) : QWidget(parent)
{
...
void RHotKeys::createHotkeyPage(QString title, const int &rows, const int &cols)
{
...
int RHotKeys::sortedInsert(const QString &title)
{
    int index;
...
void RHotKeys::createHotKeys(const int &index, const int &rows, const int &cols)
{
...
void RHotKeys::createIndexButton(const int &index, const QString &title, const int &keys)
{
...
void RHotKeys::createEditModeLabel(QWidget *widget)
{
...
void RHotKeys::indexPageClicked()
{
